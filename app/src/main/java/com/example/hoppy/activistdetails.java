...
public class activistdetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activistdetails);
        ...
        dr = FirebaseDatabase.getInstance().getReference("activitybookingdetails").child(currentuser);
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!fname.isEmpty() ||!lname.isEmpty() ||!mail.isEmpty() ||!num.isEmpty() ||!date.isEmpty()){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(activistdetails.this).create();
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent i = new Intent(activistdetails.this, confirmationpage.class);
                    ...
                    Toast.makeText(activistdetails.this,"Fields shall not be empty",Toast.LENGTH_LONG);
                }
